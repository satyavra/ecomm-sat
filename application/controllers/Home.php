...
class Home extends MY_Controller
{
    ...
    public function index($page = 0)
    {
        ...
        $data['sliding_cat']=$this->template . 'Home-parts/sliding-cat';
        $data['best_selling_items']=$this->template . 'Home-parts/best-selling-items';
        $data['smart_bachat']=$this->template . 'Home-parts/smart-bachat';
        $data['Bank_offer']=$this->template . 'Home-parts/bank-and-promo';
        $data['buy_one_get_one']=$this->template . 'Home-parts/buy-one-get-one';
        $data['top_saver']=$this->template . 'Home-parts/topsaver';
        $data['card_category']=$this->template . 'Home-parts/card-cat';
...
public function ProductCategory()
    {
        ...
        $this->load->view($this->template .'submenu_parts/subheader',$data);
        $this->load->view($this->template .'submenu_parts/submenu_contents',$data );

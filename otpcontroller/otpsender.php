...
// require ('http://localhost/Grofers-clone/ecomm-sat/otpcontroller/textlocal.class.php');
    ...
    function processMobileVerification()
    {
        switch ($_POST["action"]) {
            case "send_otp":
                ...
                $apiKey = urlencode('Acy+goqO0Rc-k7fVGt7M7mSg6Utcj8Tr1dS4aDnW6x');
            ...
            case "verify_otp":
                ...
                if ($otp == $_SESSION['session_otp']) {
                    ...
                    // echo json_encode("Your mobile number is verified!");
                    echo "1";
                } else {
                    // echo json_encode(array("message"=>"Mobile number verification failed"));
                                        echo "0";
